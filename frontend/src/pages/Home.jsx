...
function Home() {
  ...
  return (
    <div>
      <section className="relative bg-gradient-to-br from-primary-800 via-primary-700 to-primary-600 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <Link to="/products" className="inline-block bg-accent-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-accent-700 transition-colors shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-primary-800 mb-2">Yuqori Sifat</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-primary-800 mb-2">Tez Yetkazib Berish</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-primary-800 mb-2">Noyob Dizayn</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-primary-800 mb-4">Mashhur Mahsulotlar</h2>
          ...
          {loading ? (
            <div className="text-center py-12">
              ...
              <p className="mt-4 text-primary-700">Yuklanmoqda...</p>
            </div>
          ...
          <div className="text-center mt-12">
            <Link to="/products" className="inline-block bg-accent-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-accent-700 transition-colors shadow-md">
              Barcha mahsulotlar
            </Link>
          </div>
        </div>
