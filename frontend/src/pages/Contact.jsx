        ...
        <div className="bg-white rounded-button shadow-soft-lg p-10 border-t-4 border-accent">
          ...
          <div className="mt-8 pt-8 border-t-2 border-border-light">
            ...
            <div className="flex gap-4 justify-center">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-3 bg-primary hover:bg-primary-700 text-white rounded-lg transition-colors shadow-soft font-semibold">
              ...
              <a href="https://t.me/moongift" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-3 bg-accent hover:bg-accent/80 text-white rounded-lg transition-colors shadow-soft font-semibold">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
