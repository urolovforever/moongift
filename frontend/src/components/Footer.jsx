          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-3 justify-center md:justify-start">
                ...
                <a href="https://t.me/moongiftuz" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-accent hover:bg-accent/80 text-white rounded-lg flex items-center justify-center transition-colors shadow-soft">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
